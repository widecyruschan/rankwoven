...
const messages = {
  en: {
    ...
    analytics: {
      ...
      noDataForRangeDescription:
        'Check that the selected Property ID belongs to this site and that its host name matches the selected site. The date range is sent to GA4 without timezone conversion.',
  ...
  'zh-Hant': {
    ...
    analytics: {
      ...
      noDataForRangeDescription: '請確認目前選取的 Property ID 屬於此網站，並且 GA4 的 host name 與目前站點一致。日期範圍會原樣傳給 GA4，不會進行時區轉換。',
