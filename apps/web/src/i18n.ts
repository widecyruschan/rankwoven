...
const messages = {
  en: {
    ...
    media: {
      ...
      generateSuccess: '{count} media SEO suggestions refreshed',
      generateFailed: 'Unable to generate media suggestions',
  ...
  'zh-Hant': {
    ...
    media: {
      ...
      generateSuccess: '已刷新 {count} 項媒體 SEO 建議',
      generateFailed: '無法生成媒體建議',
