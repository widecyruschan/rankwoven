...
const messages = {
  en: {
    ...
    keywordResearch: {
      ...
      longTailHint: 'Uses Google Autocomplete, Datamuse, Wikipedia, and optional Brave Search. No paid keyword API key required.',
  ...
  'zh-Hant': {
    ...
    keywordResearch: {
      ...
      longTailHint: '使用 Google Autocomplete、Datamuse、Wikipedia，以及可選的 Brave Search。無需付費關鍵詞 API Key。',
      seedKeywords: '種子關鍵詞',
