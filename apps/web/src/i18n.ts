...
const messages = {
  en: {
    ...
    siteAudit: {
      ...
      pageLimitHint: 'Maximum HTML pages for local full-site crawl (10–200). Ahrefs projects are used instead when a Project ID is set.',
      ...
      ahrefsFullSiteDescription: 'Uses the selected Ahrefs Site Audit project for site-wide health scores and issue counts. Expand an issue to load its affected URLs.',
      limitedCrawlTitle: 'Local full-site crawl (Ahrefs Project ID not set)',
      limitedCrawlDescription:
        'Run Audit Now crawls the whole site via sitemap and internal links (up to 200 pages). Add an Ahrefs Project ID in Configure Audit for Ahrefs-style health score, error/warning/notice distribution, and page-explorer URL lists. Single-page analysis only applies to the manual inputs below.',
      ...
      ahrefsProjectId: 'Ahrefs project ID',
      ahrefsProjectIdPlaceholder: 'Example: 10160558',
      ahrefsCrawlDate: 'Ahrefs crawl date (optional)',
      ahrefsComparisonDate: 'Ahrefs comparison date (optional)',
      ahrefsDatePlaceholder: '2026-09-12T02:21:42Z',
      ahrefsConfigHint: 'When a Project ID is set, Run Audit Now uses the Ahrefs full-site project. Otherwise it runs the local full-site crawler.',
      ...
      ahrefsBoundProjectId: 'Bound project',
      ahrefsProjectRequired: 'Enter the Ahrefs project ID before enabling full-site audit.',
  ...
  'zh-Hant': {
    ...
    siteAudit: {
      ...
      scheduleDisabled: '關閉',
      pageLimit: '頁面限制',
      pageLimitHint: '本機全站爬取最多 HTML 頁數（10–200）。若已設定 Ahrefs Project ID，則改用 Ahrefs 全站專案。',
      crawlSource: '爬取來源',
      ...
      ahrefsFullSiteDescription: '使用所選 Ahrefs Site Audit 專案取得全站健康度與問題數量；展開問題後才載入受影響 URL。',
      limitedCrawlTitle: '本機全站掃描（尚未設定 Ahrefs Project ID）',
      limitedCrawlDescription:
        '「立即執行檢測」會依 sitemap 與站內連結掃描全站（最多 200 頁）。若要取得如 Ahrefs 的健康度、錯誤／警告／注意分佈與 page-explorer URL 明細，請在「配置檢測」填入 Ahrefs Project ID。下方「單頁分析」只用於手動輸入的單一 URL。',
      ...
      ahrefsProjectId: 'Ahrefs 專案 ID',
      ahrefsProjectIdPlaceholder: '例如：10160558',
      ahrefsCrawlDate: 'Ahrefs 爬取日期（可選）',
      ahrefsComparisonDate: 'Ahrefs 對比日期（可選）',
      ahrefsDatePlaceholder: '2026-09-12T02:21:42Z',
      ahrefsConfigHint: '填入 Project ID 後，「立即執行檢測」會優先使用 Ahrefs 全站專案；否則改跑本機全站爬蟲。',
      ...
      ahrefsBoundProjectId: '已綁定專案',
      ahrefsProjectRequired: '啟用全站檢測前，請先輸入 Ahrefs 專案 ID。',
