...
export const apiConfigSchema = z.object({
  ...
  STRIPE_PRICE_STARTER_MONTHLY: optionalStringSchema,
  STRIPE_PRICE_GROWTH_MONTHLY: optionalStringSchema,
  STRIPE_PRICE_AGENCY_MONTHLY: optionalStringSchema,
  STRIPE_BILLING_PORTAL_CONFIGURATION_ID: optionalStringSchema,
